...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_wo04fiz', 'template_ugkea0w', formRef.current, {
            publicKey: 'R94IclhjsudYKcZpB',
          })
          .then(
            () => {
              setSuccess(true)
        ...
        <motion.div ref={ref} className='contact' variants={variants} initial='initial' whileInView='animate'>
            ...
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>E-Mail</h2>
                    <span>aniketbhatti2002@gmail.com</span>
                </motion.div>
            ...
            C32.666,7.326,25.339,0,16.333,0z"
                ...
                <motion.form ref={formRef} onSubmit={sendEmail} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:4, duration:1}}>
                    ...
                    {error && "Error Mail has not been sent, TRY AGAIN"}
                    {success && "Mail has been sent SUCESSFULLY!"}
